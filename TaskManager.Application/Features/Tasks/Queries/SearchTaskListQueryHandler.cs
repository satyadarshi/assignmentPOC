...
{
    public class SearchTaskListQueryHandler : IRequestHandler<SearchTaskListQuery, List<GetTaskListViewModel>>
    {
        private readonly ITaskRepository taskRepository;
        private readonly IActivityRepository activityRepository;
        private readonly ITagRepository tagRepository;

        public SearchTaskListQueryHandler(
        ...
        public async Task<List<GetTaskListViewModel>> Handle(SearchTaskListQuery request, CancellationToken cancellationToken)
        {
            ...
            var allTasks = await taskRepository.SearchTasksAsync(request.taskName, null, request.startDueDate, request.endDueDate, request.status);
